...
# Import settings to build the database URL
from app.config import settings  # noqa: E402

# Import Base and all models so Alembic can detect them for auto-generation
...
# Inject the database URL from our settings so alembic.ini doesn't need it
db = settings.database
if db.type == "sqlite":
    db_url = f"sqlite:///{db.sqlite_path}"
else:
    db_url = (
